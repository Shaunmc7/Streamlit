...
#Job Satisfaction
st.title(Employee satisfaction)
st.text(1 = Low, 2 = Medium, 3 = High, 4 = Very High)
...
#Education
st.title(Employee field of education)
...
st.text(1 = Below College, 2 = College, 3 = Bachelor, 4 = Master, 5 = Doctor)
Education = pd.crosstab(filtered_df.Education, filtered_df.Education.count())
st.bar_chart(Education)

#Training Plot
st.title(Number of training sessions last year)
