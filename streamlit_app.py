...
st.text("This dashboard is based on the HR dataset which contains information from 4300 employees in order to measure employee 'attrition'. On the side of the dashboard you can gain more information about this company by clicking on 'Department-Overview'. To see our Supervised Machine Learning model, click on 'Prediction-of-Attrition'")